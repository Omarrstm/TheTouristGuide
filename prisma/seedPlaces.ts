...
const OWNER_EMAIL = "omarrestom11@gmail.com";
...
async function main() {
  ...
  if (!owner) {
    throw new Error(
      `Owner account ${OWNER_EMAIL} not found in this database -- sign up with that email first, or edit OWNER_EMAIL in this script.`
    );
  }
